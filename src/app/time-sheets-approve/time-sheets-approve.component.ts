...
@Component({
  ...
  templateUrl: './time-sheets-approve.component.html',
  styleUrls: ['./time-sheets-approve.component.css']
})
export class TimeSheetsApproveComponent implements OnInit {
  size: number = 5;
  page: number = 0;
  total: number;
  ...
  submitForApproval(res: Timesheets): void {
    ...
    const dialogRef = this.matDialog.open(ApprovalSubmit2DialogComponent, dialogConfig);
